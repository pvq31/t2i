...
GRADIO_FILES_DIR = os.path.join(BASE_DIR, "gradio_result_files")
...
PRETRAINED_MODEL_NAME_OR_PATH = os.environ.get(
    "SEETHROUGH3D_BASE_MODEL_PATH",
    "black-forest-labs/FLUX.1-dev",
)

# The root directory where LoRA fine-tunes are stored
print("BASE_DIR:",BASE_DIR)
# LORA_WEIGHTS_ROOT = os.path.join(os.path.dirname(BASE_DIR), "checkpoints") # 原代码
LORA_WEIGHTS_ROOT="/ptpool/users/qzy/code/seethrough3d/inference/checkpoints/seethrough3d_release"
