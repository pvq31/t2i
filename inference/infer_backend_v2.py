...
class InferenceEngine:
    ...
    def load_lora(self, checkpoint_name: str, lora_weights: List[float] = [1.0]):
        ...
        """
        # Construct LoRA path
        # lora_path = os.path.join(config.LORA_WEIGHTS_ROOT, checkpoint_name, "lora.safetensors") # 原代码
    ...
    def run_inference( # 文生图推理
        ...
        try:
            ...
            self.load_lora(checkpoint_name, lora_weights=[lora_weight])
